...
async function indexJSONL() {
    ...
    const jsonlReadStream = fs.createReadStream(jsonlFilePath, {encoding: 'utf8'})
    ...
    async function indexBatch(docs, batchNum) {
        ...
        const resultsInJSONLFormat = await client.collections(indexName).documents().import(docs, {dirty_values: 'coerce_or_reject'})
